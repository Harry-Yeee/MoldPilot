...
const workflowMessageKeyByText = {
  ...
  "The downloaded PDF is empty.": "workflow.pdfEmpty",
  "The downloaded attachment is not a PDF.": "workflow.pdfNotAttachment",
  "The downloaded attachment is not a valid PDF.": "workflow.pdfInvalid",
  "The protected PDF download was rejected.": "workflow.pdfRejected",
